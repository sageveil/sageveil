...
local function set_highlights()
	...
	local highlights = {
		...
		FloatTitle = { fg = palette.cyan, bg = palette.overlay, bold = bold, transparent_bg = true },
		...
		PmenuMatch = { fg = palette.magenta_bright, bold = bold },
		PmenuMatchSel = { fg = palette.magenta_bright, bold = bold },
		...
		Search = { fg = palette.yellow_bright, bg = palette.highlight },
		...
		SpellRare = { undercurl = true, sp = palette.magenta },
		...
		Conditional = { fg = palette.magenta, bold = bold },
		...
		["@type"] = { link = "Type" },
		["@type.builtin"] = { fg = palette.blue, italic = italic },
		["@string"] = { link = "String" },
		["@number"] = { link = "Number" },
		...
		["@attribute"] = { fg = palette.magenta_bright },
		...
		["@markup.heading"] = { fg = palette.white, bold = bold },
		["@markup.heading.1"] = { fg = palette.green_bright, bold = bold },
		["@markup.heading.2"] = { fg = palette.magenta, bold = bold },
		["@markup.heading.3"] = { fg = palette.green, bold = bold },
		["@markup.heading.4"] = { fg = palette.cyan, bold = bold },
		["@markup.heading.5"] = { fg = palette.blue, bold = bold },
		["@markup.heading.6"] = { fg = palette.muted, bold = bold },
		["@markup.raw"] = { fg = palette.cyan },
		["@markup.raw.block"] = { fg = palette.white },
		...
		LspSignatureActiveParameter = { fg = palette.yellow_bright, bold = bold },
		LspInlayHint = { fg = palette.dim, bg = palette.surface },
	}
